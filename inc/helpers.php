...
function accr_icon( $slug, $attrs = array() ) {
	...
	$paths = array(
		...
		'building_alt2' => '<path d="M15 16H17V8H11V16H13V10H15V16ZM1 16V1C1 0.734784 1.10536 0.48043 1.29289 0.292893C1.48043 0.105357 1.73478 0 2 0H16C16.2652 0 16.5196 0.105357 16.7071 0.292893C16.8946 0.48043 17 0.734784 17 1V6H19V16H20V18H0V16H1ZM5 8V10H7V8H5ZM5 12V14H7V12H5ZM5 4V6H7V4H5Z" fill="currentColor" />',
		...
		'star'          => '<path d="M3.825 19L5.45 11.975L0 7.25L7.2 6.625L10 0L12.8 6.625L20 7.25L14.55 11.975L16.175 19L10 15.275L3.825 19Z" fill="currentColor" />',
		'hard_hat'      => '<path d="M11 7.25V1C11 0.446875 10.5531 0 10 0H8C7.44688 0 7 0.446875 7 1V7.25C7 7.66563 6.66563 8 6.25 8C5.83437 8 5.5 7.66563 5.5 7.25V1.44063C2.8125 2.43125 1 4.99375 1 8V10H17V8C16.9688 5.025 15.175 2.44687 12.5 1.44375V7.25C12.5 7.66563 12.1656 8 11.75 8C11.3344 8 11 7.66563 11 7.25ZM1.25 11.5C0.559375 11.5 0 12.0594 0 12.75C0 13.4406 0.559375 14 1.25 14H16.75C17.4406 14 18 13.4406 18 12.75C18 12.0594 17.4406 11.5 16.75 11.5H1.25Z" fill="currentColor" />',
