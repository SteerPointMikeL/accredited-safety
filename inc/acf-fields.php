			...
			'fields' => array(
				array(
					...
					'layouts'    => array(
						...
						/* -------------------------------------------------- */
						'layout_staff_grid' => array(
							'key'     => 'layout_staff_grid',
							'name'    => 'staff_grid',
							'label'   => 'Staff grid (team members + optional detail modal)',
							'display' => 'block',
							'sub_fields' => array(
								array( 'key' => 'f_sg_eyebrow', 'label' => 'Eyebrow (optional)', 'name' => 'eyebrow', 'type' => 'text' ),
								array( 'key' => 'f_sg_title',   'label' => 'Heading (centered, HTML allowed)', 'name' => 'title', 'type' => 'textarea', 'rows' => 2, 'new_lines' => '' ),
								array( 'key' => 'f_sg_intro',   'label' => 'Intro (optional)', 'name' => 'intro', 'type' => 'textarea', 'rows' => 3, 'new_lines' => 'wpautop' ),
								array(
									'key'     => 'f_sg_cols',
									'label'   => 'Columns',
									'name'    => 'columns',
								...
								array(
									...
									'sub_fields'   => array(
										array( 'key' => 'f_sg_m_photo', 'label' => 'Photo', 'name' => 'photo', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium', 'instructions' => 'Leave empty to show a "Photo not available" placeholder.' ),
										array( 'key' => 'f_sg_m_name',  'label' => 'Name', 'name' => 'name', 'type' => 'text', 'required' => 1 ),
										array( 'key' => 'f_sg_m_role',  'label' => 'Role / title', 'name' => 'role', 'type' => 'text' ),
										array(
											'key'          => 'f_sg_m_details',
											'label'        => 'Card detail lines (optional)',
											'name'         => 'details',
											'type'         => 'repeater',
											'layout'       => 'table',
											'button_label' => 'Add detail line',
											'instructions' => 'Short labelled lines shown on the card, e.g. "CCO Certifications" then "ABC, ABL, ...".',
											'sub_fields'   => array(
												array( 'key' => 'f_sg_m_detail_heading', 'label' => 'Heading', 'name' => 'heading', 'type' => 'text' ),
												array( 'key' => 'f_sg_m_detail_text',    'label' => 'Text', 'name' => 'text', 'type' => 'text' ),
											),
										),
										array( 'key' => 'f_sg_m_email', 'label' => 'Email (optional, shown as button)', 'name' => 'email', 'type' => 'email' ),
										array(
											'key'          => 'f_sg_m_modal',
											'label'        => 'Detailed bio / modal content (optional)',
											'name'         => 'modal_content',
											'type'         => 'wysiwyg',
											'tabs'         => 'all',
											'toolbar'      => 'basic',
											'media_upload' => 0,
											'instructions' => 'If filled, the card becomes a button that opens a modal with this content. If empty, the card is static (no modal).',
										),
									),
								),
							),
